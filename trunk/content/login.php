...
<form  action="" method="post" accept-charset="ISO-8859-1">
	<input class="formfield" name="email" id="email" type="text" size="40" onclick="yaapps.getHelp('EMAIL_ADDRESS_LOGIN');" onfocus="emptyField(this, 'onFocus', 'Enter your email adress.');" onchange="yaapps.checkIfUserExists(this, false);" onblur="emptyField(this, 'onBlur', 'Enter your email adress.');" maxlength="40" value="Enter your email adress." />
    ...
    <p><a href="?page=register" onmouseover="yaapps.getHelp('REGISTER_DESCRIPTION');">Register an account.</a></p>
</form>	
</div>
